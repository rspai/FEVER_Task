...
class ModelConfig():
    ...
    def __addArguments(self):
        ...
        self.__parser.add_argument('--vocab_path',
                                   '-vp',
                                   default='./data/clean_data/vocab.txt',
                                   type=str,
        ...
        self.__parser.add_argument('--trainset_path',
                                   '-trp',
                                   default='./data/clean_data/train.txt',
                                   type=str,
                                   help='Training set path')
        self.__parser.add_argument('--devset_path',
                                   '-dp',
                                   default='./data/clean_data/dev.txt',
                                   type=str,
                                   help='Validation set path')
        self.__parser.add_argument('--testset_path',
                                   '-tep',
                                   default='./data/clean_data/test.txt',
                                   type=str,
    ...
    def __readConfig(self):
        ...
        with open("./config/config.yaml") as conf:
